      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-20 relative items-center justify-center">
          ...
          <div className="flex flex-col items-center relative">
            ...
            />
            <Card className="dark:bg-[var(--primary)] bg-[var(--primary)] w-full md:w-[350px] flex flex-col items-center gap-4 rounded-3xl hover:animate-pulse">
        ...
        <div className="max-w-5xl mx-auto px-4 mb-16">
          <div className="rounded-2xl overflow-hidden shadow-lg">
            <iframe
              ...
              src="https://www.google.com/maps/d/embed?mid=1M5BYnooE-DF2_JYs838FgDQLai6wBCI&ehbc=2E312F" 
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
