  ...
  export const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      description: 'La maîtrise des flux financiers est indissociable de la performance opérationnelle. '+
                 'Chez TOM, la finance n’est pas un service support : c’est un levier stratégique. '+
                 'Chaque donnée fiable, chaque information transparente, chaque processus contribue à accélérer vos opérations, '+
                 'à sécuriser vos transactions et à garantir la performance de bout en bout.'+
    ...
    },
    {
        ...
        description: 'Premier port sec du Sénégal, et référence logistique pour toute l’Afrique de l’Ouest,'+
                 'TOM MEDLOG est un acteur structurant du secteur depuis 2008, '+
                 'avec une ambition claire : faire de la logistique un accélérateur de croissance. '+
                 'Entreprise profondément sénégalaise, portée par des équipes locales engagées, '+
                 'nous accompagnons chaque jour les importateurs, exportateurs, '+
