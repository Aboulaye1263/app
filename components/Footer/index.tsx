        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-justify">
              En tant qu’acteur majeur de la logistique en Afrique de
              l’Ouest, TOM contribue au développement économique du Sénégal. Grâce à
              des infrastructures modernes et à son expertise qui facilitent les échanges
              commerciaux et soutiennent la croissance des entreprises locales.
            </p>
          </div>
        </div>
